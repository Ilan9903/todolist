...
class RolesPermissionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Permission::create(['name' => 'create team']); // 1
        Permission::create(['name' => 'assign user to team']); // 2
        Permission::create(['name' => 'edit team']); // 2
        Permission::create(['name' => 'delete team']); // 2
        Permission::create(['name' => 'view teams']); //
        Permission::create(['name' => 'create project']); // 1
        Permission::create(['name' => 'assign team to project']); // 3
        Permission::create(['name' => 'assign user to project']); // 3
        Permission::create(['name' => 'edit project']); // 3
        Permission::create(['name' => 'delete project']); // 3
        ...
        $role = Role::create(['name' => 'owner team']); // 2
        $role->givePermissionTo('edit team',
            'assign user to team',
            'delete team',
        );
